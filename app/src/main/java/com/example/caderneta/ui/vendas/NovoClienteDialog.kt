...
class NovoClienteDialog(
    ...
    private fun setupInputValidation() {
        binding.etNome.addTextChangedListener(
            object : TextWatcher {
    ...
    private fun updateSublocal2Spinner(sublocais: List<Local>) {
        ...
        binding.tilSublocal2.visibility =
            if (sublocais.isNotEmpty() &&
    ...
    private fun updateSublocal3Spinner(sublocais: List<Local>) {
        ...
        binding.tilSublocal3.visibility =
            if (sublocais.isNotEmpty() &&
            ...
            hierarchy.forEachIndexed { index, local ->
                when (index) {
                    ...
                    1 -> {
                        ...
                        binding.tilSublocal1.visibility =
                    ...
                    2 -> {
                        ...
                        binding.tilSublocal2.visibility =
                            if (!binding.spinnerSublocal1.text.isNullOrBlank()) {
                                View.VISIBLE
                            } else {
                                View.GONE
                            }
                    ...
                    3 -> {
                        ...
                        binding.tilSublocal3.visibility =
                            if (!binding.spinnerSublocal2.text.isNullOrBlank()) {
                                View.VISIBLE
                            } else {
                                View.GONE
                            }
