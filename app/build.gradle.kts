...
val composeBom = "2025.10.00" // Exemplo: Verifique a BOM estável mais recente (ex: lançada em Abril/Maio de 2024 para uso em 2025)
// ou a mais atual no momento que estiver configurando.
val roomVersion = "2.8.2"    // Seu arquivo original tinha Room 2.6.1. Seus logs mostraram download de 2.7.1.
